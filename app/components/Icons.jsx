...
export function IconPhone(props) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden {...props}>
      <path d="M22 16.92V21a2 2 0 0 1-2.18 2A19.86 19.86 0 0 1 3 5.18 2 2 0 0 1 5 3h4.09a2 2 0 0 1 2 1.72l.57 4.06a2 2 0 0 1-.57 1.7l-2.2 2.2a16 16 0 0 0 6.4 6.4l2.2-2.2a2 2 0 0 1 1.7-.57l4.06.57A2 2 0 0 1 22 16.92z"></path>
    </svg>
  );
}
